...
export default function Fo
 const getCookie = name => {
    ...
    Here is a list of things that were already tried:
    []
    ...
    <footer>
      <div className="mt-16 flex flex-col items-center">
        ...
        <div className="mb-6 flex space-x-2 text-sm text-gray-600 dark:text-gray-300">
          <div>{siteMetadata.author}</div>
          <div>{` • `}</div>
          <div>{`© ${new Date().getFullYear()}`}</div>
          <div>{` • `}</div>
        ...
        {/* <div className="my-8 text-sm text-gray-600 dark:text-gray-300">
